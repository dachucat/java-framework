CREATE TABLE `car_advantage` (
  ...
  `attrib_key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '这个属性名称在car_map中的key值',
  PRIMARY KEY (`id`),
  UNIQUE KEY `car_advantage_attrib_key_IDX` (`attrib_key`) USING BTREE
...
CREATE TABLE `car_dictionary` (
  ...
  KEY `car_map_values_IDX` (`value`,`type`) USING BTREE
    ...
    CREATE TABLE `car_infor_attrib` (
      ...
      `attrib_key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '这个属性类型在car_dictionary中的key值',
      ...
      PRIMARY KEY (`id`),
      UNIQUE KEY `car_attrib_un` (`car_infor_id`,`attrib_key`,`value`)
    ) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
